...
> 🌐 English version (dev.to)：[eBPF on a Mac: A 5-Minute Linux VM with Multipass or Lima](https://dev.to/hyperredstart/ebpf-on-a-mac-a-5-minute-linux-vm-with-multipass-or-lima-1c38)
